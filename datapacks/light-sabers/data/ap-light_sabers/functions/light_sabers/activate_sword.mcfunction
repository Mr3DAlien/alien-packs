...
execute as @s[nbt={SelectedItem:{tag:{CustomModelData:5}}}] run playsound minecraft:custom.lightsaber_kylo player @a[distance=..15]
execute as @s[nbt=!{SelectedItem:{tag:{CustomModelData:5}}}] run playsound minecraft:custom.lightsaber player @a[distance=..15]
