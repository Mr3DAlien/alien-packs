...
execute if score %backPortal ap-rm_settings matches 120.. as @a[predicate=ap-rm_portalgun:dimension_check/in_lost_place] at @s run function ap-rm_portalgun:portal/fixed_portal/select
