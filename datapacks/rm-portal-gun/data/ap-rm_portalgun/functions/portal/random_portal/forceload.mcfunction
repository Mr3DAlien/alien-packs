...
effect give @s[type=minecraft:player] minecraft:levitation 999999 255 true
...
execute if score @s ap-rm_chunk_loading matches 1..2 run function ap-rm_portalgun:portal/random_portal/tp