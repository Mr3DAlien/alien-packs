...
execute as @a[predicate=ap-rm_portalgun:portal_gun/ricks_gun/mining_gun/click] at @s anchored eyes run function ap-rm_portalgun:projectile/mining_fluid/projectile
execute as @a[predicate=ap-rm_portalgun:portal_gun/ricks_first_gun/mining_gun/click] at @s anchored eyes run function ap-rm_portalgun:projectile/mining_fluid/projectile
execute as @a[predicate=ap-rm_portalgun:portal_gun/ricks_old_gun/mining_gun/click] at @s anchored eyes run function ap-rm_portalgun:projectile/mining_fluid/projectile
