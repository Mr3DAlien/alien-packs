...
execute as @e[type=minecraft:item,nbt={Item:{tag:{RMGui:1b}}},sort=nearest] at @s run function ap-rm_portalgun:liquid_filler/gui/copy
...
data modify block ~ ~ ~ Items append from storage ap-rm_portalgun:liquid_filler Items[]
