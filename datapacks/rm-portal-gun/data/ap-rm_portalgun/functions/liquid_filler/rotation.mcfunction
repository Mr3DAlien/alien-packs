...
execute as @s[tag=ap-rm_liquid_placer] at @s as @e[type=minecraft:glow_item_frame,tag=ap-rm_liquid_filler,sort=nearest,limit=1] at @s run function ap-rm_portalgun:liquid_filler/place
