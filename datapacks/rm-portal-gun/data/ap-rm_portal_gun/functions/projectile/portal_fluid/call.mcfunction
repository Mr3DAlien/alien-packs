...
execute as @e[tag=ap-rm_fixed_portal,tag=!ap-rm_portal_setup,nbt={OnGround:1b}] at @s run function ap-rm_portal_gun:projectile/portal_fluid/create_fixed_portal