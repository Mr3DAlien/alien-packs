...
execute if score @s ap-rm_portal_id matches 2 if predicate ap-rm_portal_gun:dimension_check/in_chess_world run scoreboard players set @s ap-rm_portal_id 3
execute if score @s ap-rm_portal_id matches 3 if predicate ap-rm_portal_gun:dimension_check/in_glass_world run scoreboard players set @s ap-rm_portal_id 1
