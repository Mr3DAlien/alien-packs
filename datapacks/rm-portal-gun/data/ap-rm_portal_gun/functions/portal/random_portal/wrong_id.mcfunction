...
execute if score @s ap-rm_portal_id matches 12 if predicate ap-rm_portal_gun:dimension_check/in_the_abyss store result score @s ap-rm_portal_id run loot spawn ~ ~ ~ loot ap-rm_portal_gun:chests/world_selector

execute if score @s ap-rm_portal_id matches 999998 if predicate ap-rm_portal_gun:dimension_check/in_the_nether store result score @s ap-rm_portal_id run loot spawn ~ ~ ~ loot ap-rm_portal_gun:chests/world_selector
execute if score @s ap-rm_portal_id matches 999999 if predicate ap-rm_portal_gun:dimension_check/in_the_end store result score @s ap-rm_portal_id run loot spawn ~ ~ ~ loot ap-rm_portal_gun:chests/world_selector
