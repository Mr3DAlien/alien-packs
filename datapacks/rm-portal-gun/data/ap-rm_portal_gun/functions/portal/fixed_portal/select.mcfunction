...
execute as @s[type=minecraft:player] if predicate ap-rm_portal_gun:dimension_check/in_overworld in ap-rm_portal_gun:rick_council run tp @s 11.5 73.0 993.5 0 0