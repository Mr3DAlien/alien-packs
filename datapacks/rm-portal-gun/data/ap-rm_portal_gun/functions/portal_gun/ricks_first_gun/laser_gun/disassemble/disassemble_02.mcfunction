...
summon minecraft:item ~ ~ ~ {Item:{id:"minecraft:diamond_sword",Count:1b,tag:{RMLaserCapsule:2b,Unbreakable:1b,HideFlags:63s,RepairCost:999999,CustomModelData:9,display:{Name:'{"translate":"item.alien-packs.rm_portal_gun.liquid_capsule.name"}',Lore:['{"translate":"item.alien-packs.rm_portal_gun.liquid_capsule.description.laser_fluid"}']},AttributeModifiers:[{}]}}}