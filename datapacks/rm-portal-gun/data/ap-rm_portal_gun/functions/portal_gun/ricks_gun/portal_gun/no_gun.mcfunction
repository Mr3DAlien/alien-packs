...
item replace entity @s[predicate=ap-rm_portal_gun:portal_gun/broken_portal_gun] weapon.mainhand with minecraft:diamond_sword{CustomModelData:16,Unbreakable:1b,RepairCost:999999,HideFlags:63s,AttributeModifiers:[{}],display:{Name:'{"translate":"item.alien-packs.rm_portal_gun.broken_portal_gun_empty.name"}'}}