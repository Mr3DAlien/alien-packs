...
execute if predicate ap-rm_portal_gun:dimension_check/in_froopyland run data merge entity @s {Item:{tag:{CustomModelData:3,RMGlobe:1,display:{Lore:['[{"translate": "item.alien-packs.rm_portal_gun.dimension_globe.description.froppyland"}]']}}}}
execute if predicate ap-rm_portal_gun:dimension_check/in_chess_world run data merge entity @s {Item:{tag:{CustomModelData:4,RMGlobe:2,display:{Lore:['[{"translate":"item.alien-packs.rm_portal_gun.dimension_globe.description.chess_world"}]']}}}}
...
execute if predicate ap-rm_portal_gun:dimension_check/in_the_nether run data merge entity @s {Item:{tag:{CustomModelData:15,RMGlobe:999998,display:{Lore:['[{"translate":"item.alien-packs.rm_portal_gun.dimension_globe.description.the_nether"}]']}}}}
execute if predicate ap-rm_portal_gun:dimension_check/in_the_end run data merge entity @s {Item:{tag:{CustomModelData:16,RMGlobe:999999,display:{Lore:['[{"translate":"item.alien-packs.rm_portal_gun.dimension_globe.description.the_end"}]']}}}}
