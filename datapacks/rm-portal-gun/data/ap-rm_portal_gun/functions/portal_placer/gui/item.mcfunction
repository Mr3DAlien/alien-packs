...
execute as @e[type=minecraft:item,nbt={Item:{tag:{RMGui:1b}}},sort=nearest] at @s run function ap-rm_portal_gun:portal_placer/gui/copy
...
data modify block ~ ~ ~ Items append from storage ap-rm_portal_gun:portal_placer Items[]
