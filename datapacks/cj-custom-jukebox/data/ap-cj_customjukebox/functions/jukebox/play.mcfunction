...
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:1b}}} run playsound ap-rm_portalgun:music_disc.strange_occurance record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:2b}}} run playsound ap-rm_portalgun:music_disc.toybox record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:3b}}} run playsound ap-rm_portalgun:music_disc.shivers record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:4b}}} run playsound ap-rm_portalgun:music_disc.at_the_end_of_the_day record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:5b}}} run playsound ap-rm_portalgun:music_disc.foreign_fields record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:6b}}} run playsound ap-rm_portalgun:music_disc.house_of_madness record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:7b}}} run playsound ap-rm_portalgun:music_disc.howling_peaks record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:8b}}} run playsound ap-rm_portalgun:music_disc.lost_in_the_halls record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:9b}}} run playsound ap-rm_portalgun:music_disc.that_day record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:10b}}} run playsound ap-rm_portalgun:music_disc.the_bliss_of_the_past record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:11b}}} run playsound ap-rm_portalgun:music_disc.the_source record @a[distance=..66]
execute if block ~ ~ ~ minecraft:jukebox{RecordItem:{tag:{CJDisc:12b}}} run playsound ap-rm_portalgun:music_disc.what_could_have_been record @a[distance=..66]
